...
| 축(Axis) | 값 | 의미 |
|---|---|---|
> **⚠️ 2026-09-15 — 실제 달력을 붙여 보니 4주짜리 달이 존재합니다.**
> 그 달이 **정확히 28일이고 일요일에 시작**하면 4개 행으로 끝납니다(가장 가까운 예: **2026년 2월**).
> 평년 2월에서만 나오고, 윤년이나 29~31일 달에서는 생기지 않습니다.
> Figma 에는 `Week Number=4` 변형이 없어서, 구현은 **빈 주를 한 줄 더해 5주로 맞춥니다**
> (`storybook/src/components/Calendar/calendar-data.ts`). 높이가 달마다 튀지 않게 하려는 선택이며,
> Figma 에 4주 변형을 추가할지는 **디자이너 확인 필요**.
