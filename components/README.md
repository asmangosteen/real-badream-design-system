...
| Page Control | [components/page-control/page-control.md](./page-control/page-control.md) | 완료 | 70개 인스턴스 (Type On Light/On Dark × Dots 2~7/8+ × Selection 1~Dots, 비직교). 캐러셀 페이지 인디케이터. Dots=8+는 선택 위치에서 먼 쪽 끝 도트가 반지름 축소되는 오버플로우 표현. State 축 없음. 9개 노드 전략적 샘플링(0장 참고) |
