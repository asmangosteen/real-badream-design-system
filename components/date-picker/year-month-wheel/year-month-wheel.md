...
**핵심 발견 2 — 연/월은 독립된 두 개의 휠(사용자 확인 완료)**: 7행의 연도와 월이 동시에 1씩 증가하는 스냅샷(1997→2003, 10월→익월 순환하여 4월, 1999→2000/12월→1월 롤오버 포함)이 관찰되었습니다. 초안에서는 이것이 "연-월"을 한 덩어리로 묶어 스크롤하는 단일 시퀀스 휠일 가능성을 제기했으나, **사용자 확인 결과 연도와 월은 각각 독립적으로 스크롤되는 두 개의 휠입니다.** 이 노드의 정적 샘플이 연·월을 나란히 1씩 증가시켜 진열한 것은 편의상의 스냅샷일 뿐, 두 컬럼이 실제로 함께 묶여 움직인다는 근거는 아니었습니다.
...
**확인 완료(사용자 확인)**
- 연도·월은 독립된 두 개의 휠입니다(2장 핵심 발견 2)
