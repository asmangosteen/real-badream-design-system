    ...
    docs: {
      description: {
        component: [
          ...
          '',
          '## 너비는 가변입니다',
          '컨테이너 너비는 **고정이 아니라 부모 폭에 맞춰 늘어납니다**(디자이너 확인 완료).',
          'Figma 노드에 박힌 280px 는 진열 프레임 폭일 뿐입니다 — 이 컴포넌트를 쓰는',
          'Text Input·Dropdown·Text Input Group 이 전부 같은 규칙이라, 안내 문구만 280px 로',
          '멈추면 그 위 입력칸과 폭이 어긋납니다.',
          '',
          '## ⚠️ 확인이 필요한 것들',
