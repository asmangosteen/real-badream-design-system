    ...
    docs: {
      description: {
        component: [
          ...
          '',
          '**맨 끝이 Button이면 우측 패딩이 `spacing/11`(20px)입니다** (디자이너 지시, 2026-09-15 — Figma는 12px 고정).',
          '아이콘은 Icon Button L(40×40) 안에 24px 글리프가 놓여 좌우 8px이 남으므로,',
          '12(묶음) + 8(버튼 안쪽) = **글리프가 이미 화면 끝에서 20px** 안쪽입니다.',
          '반면 Text Button은 `padding: 0`이라 글자가 상자 끝까지 차서 12px밖에 안 남아 아이콘보다 8px 튀어나와 보입니다.',
          '그래서 맨 끝이 버튼일 때만 패딩을 올려 **아이콘·버튼 모두 끝에서 20px**에 서게 맞춥니다.',
          '',
