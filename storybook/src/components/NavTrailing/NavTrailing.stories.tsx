    ...
    docs: {
      description: {
        component: [
          ...
          '',
          '## ⚠️ 맨 오른쪽이 버튼이면 우측 끝에서 20px',
          '',
          '같은 이유가 오른쪽 끝에도 적용됩니다. 아이콘은 Icon Button 안쪽 여백 8px을 자기가 갖고 있어',
          '묶음 패딩이 12px이어도 **글리프는 우측 끝에서 20px**(12+8)에 놓입니다.',
          '반면 버튼 자리는 hug라 여백이 없어 글자가 12px에 붙어 **혼자 바깥으로 튀어나와** 보입니다.',
          '그래서 마지막 항목이 버튼이면 8px을 더해 **12 + 8 = 20px**로 맞춥니다.',
          '',
          ...
          '| 버튼 | **20px** | **20px** |',
          '',
          '> ⚠️ **이 값의 근거는 Figma가 아니라 사용자 지시(2026-09-15)입니다.** Figma의 Trailing은 아직 우측 12px 하나뿐입니다 —',
          '> 재실측하고 12px로 되돌리지 마세요.',
          '',
